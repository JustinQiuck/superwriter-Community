import type { BeatDefinition } from "@/types/entity";
...
export const PRESET_TEMPLATES: PresetTemplate[] = [
  {
    name: "三幕式结构",
    description: "经典的三幕式叙事结构：建置、对抗、结局。适合大多数类型的长篇小说。",
  ...
  {
    name: "英雄之旅",
    description: "约瑟夫·坎贝尔的经典英雄之旅模式，适合冒险、成长类故事。",
  ...
  {
    name: "救猫咪",
    description: "布莱克·斯奈德的15拍编剧法，节奏明快，适合商业类型小说。",
  ...
  {
    name: "雪花法",
    description: "兰迪·英格曼森的雪花扩展法，从核心句逐步展开为完整大纲。适合从零开始的创作者。",
    template_type: "snowflake",
    beat_definitions: [
  ...
  {
    name: "七点式结构",
    description: "丹·威尔斯的七点式故事结构，注重转折和角色成长弧线。",
  ...
  {
    name: "故事圈",
    description: "丹·哈蒙的故事圈理论，八个步骤形成完整的角色成长循环。",
    template_type: "dan_harmon_story",
    beat_definitions: [
